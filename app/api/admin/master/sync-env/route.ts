...
const SYNC_KEYS: Array<{ key: string; category: string; isSecret: boolean }> = [
  ...
  { key: "COMFY_CLOUD_API_KEY", category: "image-provider", isSecret: true },
  { key: "COMFY_CLOUD_BASE_URL", category: "image-provider", isSecret: false },
  { key: "COMFY_CLOUD_IMAGE_WORKFLOW", category: "image-provider", isSecret: true },
  { key: "COMFY_CLOUD_IMAGE_WORKFLOW_PATH", category: "image-provider", isSecret: false },
  { key: "COMFY_CLOUD_VIDEO_WORKFLOW", category: "image-provider", isSecret: true },
  { key: "COMFY_CLOUD_VIDEO_WORKFLOW_PATH", category: "image-provider", isSecret: false },
  { key: "COMFY_CLOUD_PROMPT_NODE", category: "image-provider", isSecret: false },
  { key: "COMFY_CLOUD_PROMPT_INPUT", category: "image-provider", isSecret: false },
  { key: "COMFY_CLOUD_NEGATIVE_NODE", category: "image-provider", isSecret: false },
  { key: "COMFY_CLOUD_NEGATIVE_INPUT", category: "image-provider", isSecret: false },
  { key: "COMFY_CLOUD_WIDTH_NODE", category: "image-provider", isSecret: false },
  { key: "COMFY_CLOUD_WIDTH_INPUT", category: "image-provider", isSecret: false },
  { key: "COMFY_CLOUD_HEIGHT_NODE", category: "image-provider", isSecret: false },
  { key: "COMFY_CLOUD_HEIGHT_INPUT", category: "image-provider", isSecret: false },
  { key: "COMFY_CLOUD_SEED_NODE", category: "image-provider", isSecret: false },
  { key: "COMFY_CLOUD_SEED_INPUT", category: "image-provider", isSecret: false },
  { key: "COMFYUI_BASE_URL", category: "image-provider", isSecret: false },
  { key: "STUDIO_FLUX_SCHNELL_WORKFLOW", category: "image-provider", isSecret: false },
  { key: "STUDIO_SDXL_WORKFLOW", category: "image-provider", isSecret: false },
  { key: "FFMPEG_PATH", category: "image-provider", isSecret: false },
