...
const KNOWN_KEYS: Array<{
  ...
  { key: "OPENAI_API_KEY", label: "OpenAI API Key", category: "ai-provider", isSecret: true },
  { key: "ANTHROPIC_API_KEY", label: "Anthropic API Key", category: "ai-provider", isSecret: true },
  { key: "GEMINI_API_KEY", label: "Gemini API Key", category: "ai-provider", isSecret: true },
  { key: "DEEPSEEK_API_KEY", label: "DeepSeek API Key", category: "ai-provider", isSecret: true },
  ...
  { key: "COMFY_CLOUD_API_KEY", label: "Comfy Cloud API Key", category: "image-provider", isSecret: true, description: "Default production provider for AI Studio image/video generation" },
  { key: "COMFY_CLOUD_BASE_URL", label: "Comfy Cloud Base URL", category: "image-provider", isSecret: false, description: "Defaults to https://cloud.comfy.org" },
  { key: "COMFY_CLOUD_IMAGE_WORKFLOW", label: "Comfy Cloud Image Workflow JSON", category: "image-provider", isSecret: true, description: "ComfyUI API workflow JSON for FLUX.1 Schnell. Supports {{PROMPT}}, {{NEGATIVE_PROMPT}}, {{WIDTH}}, {{HEIGHT}}, {{SEED}}." },
  { key: "COMFY_CLOUD_IMAGE_WORKFLOW_PATH", label: "Comfy Cloud Image Workflow Path", category: "image-provider", isSecret: false, description: "Server path to image workflow JSON if not stored in vault" },
  { key: "COMFY_CLOUD_VIDEO_WORKFLOW", label: "Comfy Cloud Video Workflow JSON", category: "image-provider", isSecret: true, description: "ComfyUI API workflow JSON for Wan 2.x. Supports {{PROMPT}}, {{DURATION}}, {{FPS}}, {{ASPECT_RATIO}}." },
  { key: "COMFY_CLOUD_VIDEO_WORKFLOW_PATH", label: "Comfy Cloud Video Workflow Path", category: "image-provider", isSecret: false, description: "Server path to video workflow JSON if not stored in vault" },
  { key: "COMFY_CLOUD_PROMPT_NODE", label: "Comfy Cloud Prompt Node", category: "image-provider", isSecret: false },
  { key: "COMFY_CLOUD_NEGATIVE_NODE", label: "Comfy Cloud Negative Prompt Node", category: "image-provider", isSecret: false },
  { key: "COMFY_CLOUD_WIDTH_NODE", label: "Comfy Cloud Width Node", category: "image-provider", isSecret: false },
  { key: "COMFY_CLOUD_HEIGHT_NODE", label: "Comfy Cloud Height Node", category: "image-provider", isSecret: false },
  { key: "COMFY_CLOUD_SEED_NODE", label: "Comfy Cloud Seed Node", category: "image-provider", isSecret: false },
  { key: "COMFYUI_BASE_URL", label: "ComfyUI Base URL", category: "image-provider", isSecret: false, description: "Local ComfyUI endpoint for AI Studio rendering" },
  { key: "STUDIO_FLUX_SCHNELL_WORKFLOW", label: "FLUX Schnell Workflow", category: "image-provider", isSecret: false, description: "Absolute path to the local ComfyUI FLUX workflow JSON" },
  { key: "STUDIO_SDXL_WORKFLOW", label: "SDXL Turbo Workflow", category: "image-provider", isSecret: false, description: "Absolute path to the local ComfyUI SDXL Turbo low-memory workflow JSON" },
  { key: "FFMPEG_PATH", label: "FFmpeg Path", category: "image-provider", isSecret: false },
