    ...
    <UserPanelShell title="Settings" description="Account, appearance, access, and product preferences." eyebrow="Settings">
        ...
        <PanelCard className="p-4">
          ...
          <div className="space-y-3">
            <div>
              ...
              <select className="h-10 w-full rounded-xl border border-slate-200 bg-white px-3 text-sm outline-none transition focus:border-violet-300 dark:border-white/10 dark:bg-white/[0.04]">
                ...
                {[
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        "mx-focus flex h-10 items-center justify-center gap-2 rounded-xl border text-sm font-medium transition",
                        active
            ...
            <div>
              ...
              <div className="flex h-10 items-center gap-2 rounded-xl border border-slate-200 bg-slate-50 px-3 text-sm text-slate-600 dark:border-white/10 dark:bg-white/[0.04] dark:text-slate-300">
      ...
      <div className="mt-4 grid gap-3 md:grid-cols-2 xl:grid-cols-3">
        {settingsSections.map((item) => (
          <Link key={item.href} href={item.href} className="group rounded-2xl border border-slate-200 bg-white p-4 shadow-sm transition hover:-translate-y-0.5 hover:border-violet-200 hover:shadow-md dark:border-white/10 dark:bg-[#111113] dark:hover:border-violet-400/25">
            <span className="mb-3 grid size-10 place-items-center rounded-xl bg-slate-50 text-slate-600 dark:bg-white/[0.05] dark:text-slate-300">
